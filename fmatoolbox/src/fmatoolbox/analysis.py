...
def CCG(samples, bin:float=None, limits:tuple[float,float]=None, fast:bool=None, norm:Literal['rate','count']=None):
    '''
    ...
    arguments:
        ...
        norm       str = {'rate','count'}, determines unit of measurement of 'ccg'
